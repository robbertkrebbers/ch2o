...
Section operations.
  ...
  Inductive val_refine' (Γ : env Ti) (α : bool) (f : meminj Ti)
  ...
  Section val_refine_ind.
    Context (Γ : env Ti) (α : bool) (f : meminj Ti) (Γm1 Γm2 : memenv Ti).
...
Qed.
Lemma ctree_alter_const_refine Γ α f Γm1 Γm2 g1 g2 v1 v2 τ r v3 v4 σ :
