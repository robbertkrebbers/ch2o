...
Hint Extern 0 (_\ _ ⊢ₛ _ ⇒ _) => do_cstep.
...
Proof.
  ...
  * intros m k ????; invert. exists f; eauto 10.
  * intros m k l ????; invert. exists f; eauto 10.
  * intros m k l ????; invert. exists f; eauto 10.
  * intros m k E e ????; invert. exists f; eauto 11.
  * intros m1 m2 k E e1 e2 ?????; invert.
    edestruct ehstep_refine_r as [(f'&?&?&?&?&?&?)|[??]];
      eauto using ctx_refine_stack.
    { eexists f', _; split_ands; auto.
      repeat refine_constructor; eauto 10 using ctx_refine_weaken,
         ehstep_extend, ectx_subst_refine, ectx_refine_weaken. }
    eexists f, _; split_ands; auto. right; auto.
    eexists; split_ands; repeat typed_constructor; eauto.
  * intros m k h E Ωs vs ?????; invert. eexists f, _; split_ands; auto.
  ...
  * intros; invert. edestruct val_true_refine_inv as [|[??]]; eauto.
    + eexists f, _; split_ands; auto. repeat refine_constructor;
  ...
  * intros; invert. edestruct val_false_refine_inv as [|[??]]; eauto.
    ...
    + eexists f, _; split_ands; auto; right; auto.
      eexists; split_ands; eauto; repeat typed_constructor; eauto.
  * intros; invert. exists f; eauto 10.
  * intros; invert. edestruct val_true_refine_inv as [|[??]]; eauto.
    + eexists f, _; split_ands; auto. repeat refine_constructor;
        eauto using mem_unlock_refine', ctx_refine_weaken,
        expr_refine_weaken, stmt_refine_weaken, mem_unlock_extend.
  ...
  * intros; invert. edestruct val_false_refine_inv as [|[??]]; eauto.
    ...
    + eexists f, _; split_ands; auto; right; auto.
      eexists; split_ands; eauto; repeat typed_constructor; eauto.
  * intros; invert. eexists f, _; split_ands; eauto 10.
  * intros; invert. eexists f, _; split_ands; eauto 10.
  * intros; invert. eexists f, _; split_ands; eauto 10.
  * intros; invert. eexists f, _; split_ands; eauto 10.
  * intros; invert. eexists f, _; split_ands; eauto 10.
  * intros; invert. eexists f, _; split_ands; eauto 10.
  * intros; invert. eexists f, _; split_ands; eauto.
  ...
  * intros m k h s os vs ???????; invert.
    ...
    eexists f', _; split_ands; auto. erewrite !fmap_type_of by eauto.
  ...
  * intros m k h oσs s ????; invert; case_match; simplify_equality'; try done.
    eexists f, _; split_ands; auto. rewrite !fst_zip by solve_length.
  ...
  * intros; invert. eexists f, _; split_ands;
      eauto 10 using ectx_subst_refine, locks_empty_refine.
  * intros; invert.
    eexists f, _; split_ands; eauto 10 using sctx_item_subst_refine.
    edestruct sctx_item_typed_Some_l; eauto using sctx_item_refine_typed_l.
    subst; repeat refine_constructor; eauto using sctx_item_subst_refine.
  * intros; invert. eexists f, _; split_ands; eauto.
  * intros m k Es l s ?????; invert. exists f; eauto 10.
  * intros m k Es l s ?????; invert.
    exists f; eauto 10 using sctx_item_subst_refine.
  * intros m k d o τ s ??????; invert.
    ...
    eexists f', _; split_ands; auto. repeat refine_constructor; eauto 7 using
